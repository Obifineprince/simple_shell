 ...
 *
 * This function is responsible for retrieving aliases based on the provided name.
 * It searches for the specified alias in the program's data and returns it if found.
 *
 ...
 * @input: Pointer to the program's data struct
 *
 * This function is responsible for adding or overriding an alias as provided string.
